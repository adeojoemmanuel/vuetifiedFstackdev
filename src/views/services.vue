...
<div class="position-relative spybody" data-spy="scroll" data-target=".navbar-example2" data-offset="100">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="axil-service text-left axil-control paralax-image active">
                                    <div class="inner">
                                        ...
                                        <div class="content">
                                            <h4 class="title"><a href="single-service.html">Logo & branding</a></h4>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="axil-service text-left axil-control paralax-image">
                                    <div class="inner">
                                        ...
                                        <div class="content">
                                            <h4 class="title"><a href="single-service.html">Graphic/print design</a></h4>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div class="axil-service text-left axil-control paralax-image">
                                    <div class="inner">
                                        ...
                                        <div class="content">
                                            <h4 class="title"><a href="single-service.html">Video production</a></h4>
                                            <p>From simple Content Management System to complex eCommerce developer, we cover it all. </p>
                                            <a class="axil-button" data-hover="Learn More" href="single-service.html">Learn More</a>
                                        </div>
                                    </div>
