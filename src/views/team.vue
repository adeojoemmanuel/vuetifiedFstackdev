  ...
  <div>
    ...
    <div class="main-content">
      ...
      <main class="page-wrapper page-team">
        ...
        <div
          class="axil-breadcrumb-area breadcrumb-style-2 team-group-thumb pt--170 pb--70 theme-gradient ppplr--100"
        >
          <div class="container">
              ...
              <div class="col-lg-7 order-1 order-lg-2">
                <div class="thumbnail text-left text-lg-right">
                  <div class="image-group">
                    <img
                      class="image-1"
                      src="assets/images/slider/white-shape.png"
                      alt="Slider images"
                    />
                  </div>
                  <div class="shape-group">
                    <div class="shape shape-1">
                      <img
                        src="assets/images/slider/human-1.svg"
                        alt="Shape Images"
                      />
                    </div>
                    <div class="shape shape-2">
                      <img
                        src="assets/images/slider/human-2.svg"
                        alt="Shape Images"
                      />
                    </div>
                    <div class="shape shape-3">
                      <img
                        src="assets/images/slider/human-3.svg"
                        alt="Shape Images"
                      />
                    </div>
                    <div class="shape shape-4">
                      <img
                        src="assets/images/slider/human-4.svg"
                        alt="Shape Images"
                      />
                    </div>
                  </div>
          ...
          <div class="container">
            <div class="row align-items-end">
              ...
              <div class="col-lg-12 col-xl-8 mt_lg--30 mt_md--30 mt_sm--30">
                <ul
                  class="nav nav-tabs team-nab-tabs justify-content-start justify-content-xl-end"
                  id="myTab"
                  role="tablist"
                >
                  <li class="nav-item">
            ...
            <div class="tab-content" id="myTabContent">
              ...
              >
                <div class="row">
                  <!-- Start Single Team  -->
                  <div
                    class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 mt--60 mt_sm--30 mt_md--30"
                  >
                    <div class="axil-team">
                      <div class="inner">
                        ...
                        <div class="content">
                          <h4 class="title">
                            <a href="team-details.html">Adeojo Emmanuel IBK.</a>
                          </h4>
                  ...
                  >
                    <div class="axil-team">
                      <div class="inner">
                        ...
                        <div class="content">
                          <h4 class="title">
                            <a href="team-details.html">Ogbuji Bright Obah</a>
                          </h4>
              ...
              >
                <div class="row">
                  <!-- Start Single Team  -->
                  <div
                    class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 mt--60 mt_sm--30 mt_md--30"
                  >
                    <div class="axil-team">
                      <div class="inner">
                        <div class="thumbnail paralax-image">
                        ...
                        <div class="content">
                          <h4 class="title">
                            <a href="team-details.html">Madge Alvarez</a>
                          </h4>
                          <p class="subtitle">CEO</p>
                        </div>
                      </div>
                  ...
                  >
                    <div class="axil-team">
                      <div class="inner">
                        ...
                        <div class="content">
                          <h4 class="title">
                            <a href="team-details.html">Ansa David</a>
                          </h4>
              ...
              <div class="col-lg-12">
                <div class="section-title text-center">
                  ...
                  <h2 class="title wow" data-splitting>
                    <span>Design startup movement</span>
                  </h2>
