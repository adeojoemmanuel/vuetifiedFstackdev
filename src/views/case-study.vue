        ...
        <div class="axil-featured-area ax-section-gap bg-color-lightest">
          <div class="container">
            ...
            <div class="row d-flex flex-wrap axil-featured row--0">
              ...
              <div
                class="col-lg-6 col-xl-5 offset-xl-1 col-md-12 col-12 mt_md--40 mt_sm--40"
              >
                <div class="inner">
                  <div class="section-title text-left">
                    ...
                    >
                    <h2 class="title wow">
                      <a href="single-case-study.html">Los Marineros</a>
                    </h2>
                  ...
                  <div
                    class="axil-counterup-area d-flex flex-wrap separator-line-vertical"
                  >
                    <!-- Start Counterup -->
            ...
            <!-- Start Single Feature  -->
            <div
              class="row d-flex flex-wrap axil-featured axil-featured-left row--0  ax-section-gapTop"
            >
              <div
                class="col-lg-6 col-xl-5 col-md-12 col-12 mt_md--40 mt_sm--40 order-2 order-lg-1"
              >
                <div class="inner">
                  <div class="section-title text-left">
                    <span class="sub-title extra04-color wow"
                    ...
                    >
                    <h2 class="title wow">
                      <a href="single-case-study.html">Whitehorse</a>
                    </h2>
                    <p class="subtitle-2 wow">
                      Donec metus lorem, vulputate at sapien sit amet, auctor
                      iaculis lorem. In vel hendrerit nisi. Vestibulum eget
            ...
            <!-- Start Single Feature  -->
            <div
              class="row d-flex flex-wrap axil-featured row--0 ax-section-gapTop"
            >
              <div class="col-lg-6 col-xl-6 col-md-12 col-12">
                <div class="thumbnail">
                  <a href="single-case-study.html">
              ...
              >
                <div class="inner">
                  <div class="section-title text-left">
                    ...
                    >
                    <h2 class="title wow">
                      <a href="single-case-study.html">Periscope Data</a>
                    </h2>
                    <p class="subtitle-2 wow">
                      Donec metus lorem, vulputate at sapien sit amet, auctor
                      iaculis lorem. In vel hendrerit nisi. Vestibulum eget
              ...
              >
                <div class="inner">
                  <div class="section-title text-left">
                    ...
                    >
                    <h2 class="title wow">
                      <a href="single-case-study.html">Exabeam</a>
                    </h2>
                    <p class="subtitle-2 wow">
                      Donec metus lorem, vulputate at sapien sit amet, auctor
                      iaculis lorem. In vel hendrerit nisi. Vestibulum eget
              ...
              >
                <div class="thumbnail">
                  <a href="single-case-study.html">
                    <img
                      class="image w-100 paralax-image"
                      src="assets/images/featured/featured-image-05.jpg"
                      alt="Featured Images"
                    />
                  </a>
                </div>
