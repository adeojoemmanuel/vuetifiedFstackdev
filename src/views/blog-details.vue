                    ...
                    <div class="row row--40">
                        <div class="col-lg-8 col-md-12 col-12">
                            <div class="axil-blog-details-area">
                                <div class="wrapper">
                                    <div class="blog-top">
                                        <h3 class="title">An oral history of the AIM away message (by the people who
                                            were there)</h3>
                                        <div class="author">
                                    ...
                                    <div class="content mb--40 mb_sm--20 mb_md--20">
                                        <p>Habitasse per feugiat aliquam luctus accumsan curae, suspendisse aliquam
                                            taciti eros neque, aenean sit iaculis risus commodo ut sociosqu rhoncus
                                            potenti tristique placerat sit tempus, duis erat feugiat cras sociosqu porta
                                            ut praesent, fermentum donec convallis tellus vulputate duis nibh rhoncus
                                            phasellus dui massa nisl.</p>
                                        <p>Whether you’re kicking off a new campaign or looking to revamp your strategy,
                                            the lessons you’ll learn will be universal to all small business email
                                            marketing.</p>
                                        <p>MailChimp is an email marketing service provider founded in 2001. It has 9
                                            million users that collectively send over 15 billion emails through the
                                            service each month.</p>
                                        <h3 class="mb--20">Habitasse per feugiat aliquam luctus</h3>
                                        ...
                                        <p>Whether you’re kicking off a new campaign or looking to revamp your strategy,
                                            the lessons you’ll learn will be universal to all small business email
                                            marketing.</p>
                                        <blockquote class="axil-quote">“Nunc sed mattis diam. Suspendisse mi libero,
                                            sagittis nec varius quis, pulvinar eu nisl. Nulla in accumsan orci, a varius
                                            velit. Maecenas tincidunt mauris rutrum, eleifend sem at, sollicitudin
                                            ante.”</blockquote>
                                        <h4 class="mb--30">Habitasse per feugiat aliquam luctus accumsan curae</h4>
                                        <p>Email is a crucial channel in any marketing mix, and never has this been
                                            truer than for today’s entrepreneur. Curious what to say? How to say it? How
                                            often to hit “send”? Each bite-sized lesson delivers core concepts, guiding
                                            questions, and tactical how-to resources.</p>
                                    ...
                                    <div class="row mb--60 mb_sm--30 mb_md--30">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                            <div class="thumbnail">
                                                <img class="w-100" src="assets/images/blog/list-image-01.jpg" alt="Blog Images">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-12 mt_mobile--30">
                                            <div class="thumbnail">
                                                <img class="w-100" src="assets/images/blog/list-image-01.jpg" alt="Blog Images">
                                            </div>
                                        </div>
                                    ...
                                    <div class="axil-blog-author">
                                        <div class="author d-flex">
                                            ...
                                            <div class="info">
                                                ...
                                                <p class="subtitle-2">Email is a crucial channel in any marketing mix,
                                ...
                                <div class="axil-blog-comment mt--60 mt_md--40 mt_sm--30">
                                    ...
                                    <div class="comment-list">
                                        ...
                                        <div class="comment">
                                            <div class="thumbnail">
                                                <img src="assets/images/blog/author-01.jpg" alt="Blog Comment">
                                            </div>
                                            <div class="content">
                                                <div class="heading">
                                                    <div class="title">
                                                ...
                                                <p class="description">Email is a crucial channel in any marketing mix,
                                                    and never has this been truer than for today’s entrepreneur. Curious
                                                    what to say.</p>
                                            </div>
                                        </div>
