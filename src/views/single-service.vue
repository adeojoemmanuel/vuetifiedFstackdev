            ...
            <div class="row align-items-center">
              <div class="col-lg-6 order-2 order-lg-1 mt_md--30 mt_sm--20">
                <div class="inner">
                  ...
                  <p>
                    Give your business a unique logo to stand out from the
                    crowd. We’ll create custom tailored logo specifically for
                    your company.
                  </p>
                </div>
              </div>
                ...
                <div class="thumbnail text-left text-md-right">
                  <div class="image-group">
                    <img
                      ...
                      src="assets/images/slider/single-service-02.png"
                      alt="Slider images"
                    />
                    <img
        ...
        <div class="axil-about-area ax-section-gap bg-color-white">
          <div class="container">
            <div class="row">
                  ...
                  <div class="axil-contact-form contact-form-style-1">
                    ...
                    <div class="shape-group">
                      <div class="shape shape-01">
                        <img
                          src="assets/images/others/shape-07.svg"
                          alt="Shape Images"
                        />
                      </div>
                      <div class="shape shape-02">
                        <img
                          src="assets/images/others/shape-16.svg"
                          alt="Shape Images"
                        />
                      </div>
                    </div>
              ...
              <div
                class="col-lg-6 col-xl-5 offset-xl-2 col-md-12 col-12 mt_md--40 mt_sm--40"
              >
                <div class="axil-about-inner">
                  <div class="section-title text-left">
                    ...
                    <p class="subtitle-2">
                      Ut condimentum enim nec diam convallis mollis. Sed felis
                      quam, semper dapibus purus sed, rhoncus ullamcorper lacus.
                    </p>
                  </div>
                  <!-- Start Accordion Area  -->
                  <div
                    id="accordion"
                    class="axil-accordion mt--15 mt_md--15 mt_sm--15"
                  >
                    <!-- Start Single Card  -->
                    <div class="card">
                    ...
                    <div class="card">
                      <div class="card-header" id="headingTwo">
                        <h5 class="mb-0">
                          ...
                          >
                            <i class="fal fa-code"></i><span>Design</span>
                          </button>
                        </h5>
                      </div>
                      <div
                    ...
                    <div class="card">
                      <div class="card-header" id="headingThree">
                        <h5 class="mb-0">
                          ...
                          >
                            <i class="fal fa-globe"></i><span>Development</span>
                          </button>
                        </h5>
                      </div>
                      <div
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="mesonry-list grid-metro3 mt--20">
                  ...
                  <div
                    class="portfolio portfolio_style--1 axil-control active portfolio-33-33"
                  >
                    <div class="inner move-up wow">
                      ...
                      <div class="port-overlay-info">
                        <div class="hover-action">
                          <h4 class="title">
                            <a href="single-case-study.html">Creative Agency</a>
                          </h4>
                  ...
                  <!-- Start Single Portfolio -->
                  <div
                    class="portfolio portfolio_style--1 axil-control portfolio-33-33"
                  >
                    <div class="inner move-up wow">
                      <div class="thumb paralax-image">
                        <a href="single-case-study.html"
                      ...
                      <div class="port-overlay-info">
                        <div class="hover-action">
                          <h4 class="title">
                            <a href="single-case-study.html">Rant bike</a>
                          </h4>
                  ...
                  <div class="portfolio portfolio_style--1 portfolio-33-33">
                    <div class="inner move-up wow">
                      ...
                      <div class="port-overlay-info">
                        <div class="hover-action">
                          <h4 class="title">
                            <a href="single-case-study.html">All Volees</a>
                          </h4>
                  ...
                  <div class="portfolio portfolio_style--1 portfolio-33-33">
                    <div class="inner move-up wow">
                      ...
                      <div class="port-overlay-info">
                        <div class="hover-action">
                          <h4 class="title">
                            <a href="single-case-study.html">Larq</a>
                          </h4>
                ...
                <div
                  class="view-all-portfolio-button mt--60 text-center move-up wow"
                >
