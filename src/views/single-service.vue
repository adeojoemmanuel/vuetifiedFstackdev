                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 order-2 order-lg-1 mt_md--30 mt_sm--20">
                            <div class="inner">
                                ...
                                <p>Give your business a unique logo to stand out from the crowd. We’ll create custom
                                    tailored logo specifically for your company.</p>
                            </div>
                        </div>
                            ...
                            <div class="thumbnail text-left text-md-right">
                                ...
                                <div class="shape-group">
                                    ...
                                    <div class="shape shape-3">
                                        <img class="customOne" src="assets/images/others/breadcrumb-3.svg" alt="Shape Images">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="axil-contact-form contact-form-style-1">
                                    ...
                                    <div class="shape-group">
                                        <div class="shape shape-01">
                                            <img src="assets/images/others/shape-07.svg" alt="Shape Images">
                                        </div>
                                        <div class="shape shape-02">
                                            <img src="assets/images/others/shape-16.svg" alt="Shape Images">
                                        </div>
                                    </div>
                                    <!-- End Shape Group  -->
                                </div>
                        ...
                        <div class="col-lg-6 col-xl-5 offset-xl-2 col-md-12 col-12 mt_md--40 mt_sm--40">
                            <div class="axil-about-inner">
                                <div class="section-title text-left">
                                    ...
                                    <h2 class="title">Why branding <br /> matters?</h2>
                                        <p class="subtitle-2">Ut condimentum enim nec diam convallis mollis. Sed felis quam,
                                            semper dapibus purus sed, rhoncus ullamcorper lacus.</p>
                                </div>
                                ...
                                <div id="accordion" class="axil-accordion mt--15 mt_md--15 mt_sm--15">
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                            <div class="card-body">Aenean hendrerit laoreet vehicula. Nullam convallis
                                                augue
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="headingTwo">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"><i
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="headingThree">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree"><i
