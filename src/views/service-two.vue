          ...
          <div class="container">
            <div class="row align-items-center">
              ...
              <div class="col-lg-7 order-1 order-lg-2">
                <div
                  class="breadcrumb-thumbnail-group with-image-group text-right"
                >
                  <div class="thumbnail">
                    <img
                      class="paralax-image"
        ...
        <div class="axil-service-area ax-section-gap bg-color-lightest">
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 col-12 move-up wow">
                ...
                >
                  <div class="inner">
                    ...
                    <div class="content">
                      <h4 class="title">
                        <a href="single-service.html">Visual branding</a>
                      </h4>
                      <p>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 col-12 move-up wow">
                <div
                  class="axil-service text-center axil-control paralax-image active"
                >
                  <div class="inner">
                    ...
                    <div class="content">
                      <h4 class="title">
                        <a href="single-service.html">Interaction</a>
                      </h4>
                      <p>
                        We design professional looking yet simple websites. Our
                        designs are search engine and user friendly.
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 col-12 move-up wow">
                ...
                >
                  <div class="inner">
                    ...
                    <div class="content">
                      <h4 class="title">
                        <a href="single-service.html">Creative production</a>
                      </h4>
                      <p>
                        We design professional looking yet simple websites. Our
                        designs are search engine and user friendly.
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 col-12 move-up wow">
                ...
                >
                  <div class="inner">
                    ...
                    <div class="content">
                      <h4 class="title">
                        <a href="single-service.html">Digital marketing</a>
                      </h4>
                      <p>
                        We design professional looking yet simple websites. Our
                        designs are search engine and user friendly.
        ...
        <div class="axil-service-area ax-section-gap bg-color-white">
          <div class="container">
            ...
            <div class="row">
              <!-- Start Single Service  -->
              <div
                class="col-lg-4 col-md-6 col-12 mt--50 mt_md--40 mt_sm--30 move-up wow"
              >
                <div class="axil-service-style--3">
                  ...
                  <div class="content">
                    <h4 class="title">
                      <a href="single-service.html">1. Discuss</a>
                    </h4>
                    <p>
              ...
              >
                <div class="axil-service-style--3 color-var--2">
                  ...
                  <div class="content">
                    <h4 class="title">
                      <a href="single-service.html">2. Mapping</a>
                    </h4>
                    <p>
                      Donec metus lorem, vulputate at sapien sit amet, auctor
                      iaculis lorem. In vel hendrerit nisi. Vestibulum eget
              ...
              >
                <div class="axil-service-style--3 color-var--3">
                  ...
                  <div class="content">
                    <h4 class="title">
                      <a href="single-service.html">3. Execution</a>
                    </h4>
                    <p>
                      Donec metus lorem, vulputate at sapien sit amet, auctor
                      iaculis lorem. In vel hendrerit nisi. Vestibulum eget
