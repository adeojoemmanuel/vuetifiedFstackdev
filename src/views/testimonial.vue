                    ...
                    <div class="col-lg-12">
                        <div class="inner">
                            <ul class="axil-breadcrumb liststyle d-flex">
                                ...
                                <li class="axil-breadcrumb-item active" aria-current="page">Customer Reviews</li>
                            </ul>
                            <h1 class="axil-page-title">Customer Reviews</h1>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-8 col-md-8 col-sm-8 col-12">
                            <div class="section-title text-left">
                                ...
                                <p class="subtitle-2 mb--50">In vel varius turpis, non dictum sem. Aenean in efficitur
                                    ipsum, in egestas ipsum. Mauris in mi ac tellus.</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-12 mt_mobile--20">
                            <div class="axil-social-share text-left text-sm-right">
                                <img src="assets/images/shape/google.png" alt="Social Icons">
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="axil-testimonial style-var--2 axil-control testimonial">
                                    <div class="inner">
                                        <div class="clint-info-wrapper">
                                            ...
                                            <div class="client-info">
                                                <h4 class="title">Cordelia Harvey</h4>
                                                <span>Executive Chairman @ Google</span>
                                            </div>
                                        </div>
                                        <div class="description">
                                ...
                                <div class="axil-testimonial style-var--2 axil-control testimonial">
                                    <div class="inner">
                                        <div class="clint-info-wrapper">
                                            ...
                                            <div class="client-info">
                                                <h4 class="title">Eugenia Garcia</h4>
                                                <span>Executive Chairman @ Google</span>
                                            </div>
                                        </div>
                                        <div class="description">
                                ...
                                <div class="axil-testimonial style-var--2 axil-control testimonial">
                                    <div class="inner">
                                        <div class="clint-info-wrapper">
                                            ...
                                            <div class="client-info">
                                                <h4 class="title">Edward Schwartz</h4>
                                                <span>Executive Chairman @ Google</span>
                                            </div>
                                        </div>
                                        <div class="description">
            ...
            <div class="axil-testimonial-area ax-section-gap bg-color-lightest">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-8 col-md-8 col-sm-8 col-12">
                            <div class="section-title text-left">
                                <h2 class="title">Facebook Reviews</h2>
                                <p class="subtitle-2 mb--50">In vel varius turpis, non dictum sem. Aenean in efficitur
                                    ipsum, in egestas ipsum. Mauris in mi ac tellus.</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-12 mt_mobile--20">
                            <div class="axil-social-share text-left text-sm-right">
                                <img src="assets/images/shape/facebook.png" alt="Social Icons">
                            </div>
                        </div>
                    </div>
                    <div class="testimonial-activation">
