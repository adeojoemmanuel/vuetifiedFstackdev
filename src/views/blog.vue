          ...
          <div class="container">
            <div class="row row--40">
              <div class="col-lg-8 col-md-12 col-12">
                ...
                <!-- Start Single Blog  -->
                <div
                  class="axil-blog-list wow move-up mt--80 mt_md--30 mt_sm--30 mt_lg--50"
                >
                  <div class="blog-top">
                    <h3 class="title">
                      <a href="blog-details.html"
                  ...
                  <div class="thumbnail">
                    <a href="blog-details.html">
                      <img
                        class="w-100"
                        src="assets/images/blog/blog-list-02.jpg"
                        alt="Blog Images"
                      />
                    </a>
                  </div>
                ...
                >
                  <div class="blog-top">
                    <h3 class="title">
                      <a href="blog-details.html"
                        >You can now listen to the entire library of Design
                        Better books for free</a
                      >
                    </h3>
                    <div class="author">
                      <div class="author-thumb">
                  ...
                  <div class="thumbnail">
                    <a href="blog-details.html">
                      <img
                        class="w-100"
                        src="assets/images/blog/blog-list-03.jpg"
                        alt="Blog Images"
                      />
                    </a>
                  </div>
                ...
                >
                  <div class="blog-top">
                    <h3 class="title">
                      <a href="blog-details.html"
                        >Design mentors share 11 tips for excelling at your
                        first job as a designer</a
                      >
                    </h3>
                    <div class="author">
                      <div class="author-thumb">
