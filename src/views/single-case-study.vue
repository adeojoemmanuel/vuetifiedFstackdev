<template>
    <div class="main-content">
        ...
        <main class="page-wrapper">
                        ...
                        <div class="col-lg-6 order-1 order-lg-2">
                            <div class="thumbnail text-left text-lg-right">
                                <div class="image-group text-right">
                                    <img class="image-1 paralax-image" src="assets/images/slider/breadcrumb-4.jpg" alt="Slider images">
                                ...
                                <div class="shape-group">
                                    ...
                                    <div class="shape shape-3">
                                        <img src="assets/images/others/breadcrumb-3.svg" alt="Shape Images">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <!-- Start Project Brief  -->
            <div class="axil-project-brief project-bief-styles ax-section-gap bg-color-white">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-xl-6 col-md-12 col-12">
                            <div class="thumbnail position-relative">
                                <img class="image w-100 paralax-image" src="assets/images/about/case-study-video.jpg" alt="Featured Images">
                        ...
                        <div class="col-lg-6 col-xl-5 offset-xl-1 col-md-12 col-12">
                            <div class="content mt_md--30 mt_sm--30">
                                <div class="inner move-up wow">
                                    ...
                                    <p class="mb--30">Nulla et velit gravida, facilisis quam a, molestie ante. Mauris
                                        placerat suscipit dui, eget maximus tellus blandit a. Praesent non tellus sed
                                        ligula
                                        commodo blandit in et mauris. Quisque efficitur ipsum ut dolor molestie
                                        pellentesque.</p>
                                    <p>Nulla pharetra hendrerit mi quis dapibus. Quisque luctus, tortor a venenatis
                                        fermentum, est lacus feugiat nisl, id pharetra odio enim eget libero.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Start Project Brief  -->
            <div class="axil-project-brief project-bief-styles order-style-2 ax-section-gap bg-color-lightest">
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-xl-6 offset-xl-1 col-md-12 col-12 order-1 order-lg-2">
                            <div class="thumbnail position-relative">
                                <img class="image w-100 paralax-image" src="assets/images/featured/featured-image-07.jpg" alt="Featured Images">
                                <div class="shape-group shape-01">
                                    <img src="assets/images/others/contact-01.svg" alt="">
                                </div>
                                <div class="shape-group shape-02">
                        ...
                        <div class="col-lg-8 offset-lg-2">
                            <div class="content">
                                ...
                                <div class="thumbnail mt--60 move-up wow">
                                    <img class="w-100 paralax-image" src="assets/images/featured/featured-b1.jpg" alt="Featured Images">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="section-title text-center mb--100 mb_sm--40 mb_md--40">
                                ...
                                <p class="subtitle-2 wow" data-splitting>Our comprehensive logo design strategy ensures
                                    a
                                    perfectly crafted logo for your business.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                    <div class="axil-counterup mt--60 mt_md--30 mt_sm--30 text-center counter-third">
                                        ...
                                        <p>Avarage <br /> monthly investmentsa day</p>
                                    </div>
                                </div>
                                <!-- End Counterup Area -->
                                <div class="col-lg-12">
                                    <div class="button-wrapper mt--60 text-center">
                                        <a class="axil-button btn-large btn-transparent" href="#"><span
                                                class="button-text">Launch The Site</span><span
            ...
            <div class="axil-website">
                <div class="thumbnail text-center">
                    <img src="assets/images/featured/website-image.jpg" alt="Featured Images">
                </div>
            </div>
            <!-- End Website Link  -->
