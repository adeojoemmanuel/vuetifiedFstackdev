  ...
  <div>
    ...
    <div class="main-content">
                    ...
                    <ul class="mainmenu">
                      ...
                      <li class="has-dropdown">
                        ...
                        <ul class="axil-submenu">
                          ...
                          <li>
                            <a href="blog-list-two.html">Blog List Two</a>
                          </li>
      ...
      <main class="page-wrapper">
        ...
        <div
          class="axil-breadcrumb-area breadcrumb-style-2 single-service pt--170 pb--70 theme-gradient"
        >
          <div class="container">
            <div class="row align-items-center">
              ...
              <div class="col-lg-6 order-1 order-lg-2">
                <div class="thumbnail text-left text-lg-right">
                  <div class="image-group text-right">
                    <img
                      class="image-1 paralax-image"
                      src="assets/images/slider/breadcrumb-4.jpg"
                      alt="Slider images"
                    />
                    <img
                      class="image-2 paralax-image"
                      src="assets/images/slider/single-service-01.svg"
                      alt="Slider images"
                    />
                  </div>
                  <div class="shape-group">
                    <div class="shape shape-1">
                      <img
                        src="assets/images/others/breadcrumb-1.svg"
                        alt="Shape Images"
                      />
                    </div>
                    <div class="shape shape-2">
                      <img
                        src="assets/images/others/breadcrumb-2.svg"
                        alt="Shape Images"
                      />
                    </div>
                    <div class="shape shape-3">
                      <img
                        src="assets/images/others/breadcrumb-3.svg"
                        alt="Shape Images"
                      />
                    </div>
                  </div>
        ...
        <!-- Start Project Brief  -->
        <div
          class="axil-project-brief project-bief-styles ax-section-gap bg-color-white"
        >
          <div class="container">
            <div class="row align-items-center">
              <div class="col-lg-6 col-xl-6 col-md-12 col-12">
                <div class="thumbnail position-relative">
                  <img
                    class="image w-100 paralax-image"
                    src="assets/images/about/case-study-video.jpg"
                    alt="Featured Images"
                  />
                  <div class="video-button position-to-top">
                    <a
                      class="play__btn video-btn"
                ...
                <div class="content mt_md--30 mt_sm--30">
                  <div class="inner move-up wow">
                    ...
                    <p class="mb--30">
                      ...
                      Mauris placerat suscipit dui, eget maximus tellus blandit
                      a. Praesent non tellus sed ligula commodo blandit in et
                      mauris. Quisque efficitur ipsum ut dolor molestie
                      pellentesque.
                    </p>
                    <p>
        ...
        <!-- Start Project Brief  -->
        <div
          class="axil-project-brief project-bief-styles order-style-2 ax-section-gap bg-color-lightest"
        >
          <div class="container">
            <div class="row align-items-center">
              <div
                class="col-lg-6 col-xl-5 col-md-12 col-12 order-2 order-lg-1 mt_md--30 mt_sm--30"
              >
                <div class="content">
                  <div class="inner move-up wow">
                    <h2 class="title mb--20">Project brief</h2>
              ...
              <div
                class="col-lg-6 col-xl-6 offset-xl-1 col-md-12 col-12 order-1 order-lg-2"
              >
                <div class="thumbnail position-relative">
                  <img
                    class="image w-100 paralax-image"
                    src="assets/images/featured/featured-image-07.jpg"
                    alt="Featured Images"
                  />
                  <div class="shape-group shape-01">
                    <img src="assets/images/others/contact-01.svg" alt="" />
        ...
        <div
          class="axil-project-solutions-area shape-group-position ax-section-gap bg-color-white"
        >
          <div class="container">
            <div class="row">
                ...
                <div class="content">
                  ...
                  <div class="thumbnail mt--60 move-up wow">
                    <img
                      ...
                      src="assets/images/featured/featured-b1.jpg"
                      alt="Featured Images"
                    />
                  </div>
                </div>
          ...
          <div class="shape-group">
            <div class="shape">
              <img src="assets/images/others/shape-19.svg" alt="Shape Images" />
            </div>
          </div>
        </div>
        ...
        <div class="axil-working-process-area ax-section-gap theme-gradient-4">
          <div class="container">
            <div class="row">
              <div class="col-lg-12">
                <div
                  class="section-title text-center mb--100 mb_sm--40 mb_md--40"
                >
                  <h2 class="title wow" data-splitting>Our work process</h2>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="axil-working-process mb--100 mb_md--50 mb_sm--40">
                  <div class="thumbnail">
                    <div class="image paralax-image">
                      <img
                        src="assets/images/process/process-01.jpg"
                        alt="Process Images"
                      />
                    </div>
                  </div>
                  <div class="content">
                    <div class="inner">
                      <div class="section-title">
                        ...
                        <span class="sub-title extra04-color"
                          >our four step process</span
                        >
                        <h2 class="title">Discover</h2>
                        <p class="subtitle-2">
                          Donec metus lorem, vulputate at sapien sit amet,
                          auctor iaculis lorem. In vel hendrerit nisi.
                          Vestibulum eget risus velit. Aliquam tristique libero
                          at dui sodales, et placerat orci lobortis. Maecenas
                          ipsum neque, elementum id dignissim et, imperdiet
                          vitae mauris.
                        </p>
                      </div>
                    </div>
                ...
                <!-- Start Working Process  -->
                <div
                  class="axil-working-process mb--100 text-left mb_md--50 mb_sm--40"
                >
                  <div class="content order-2 order-lg-1">
                    <div class="inner">
                      <div class="section-title">
                        <span class="process-step-number">2</span>
                        <span class="sub-title extra05-color"
                          >our four step process</span
                        >
                  ...
                  <div class="thumbnail order-1 order-lg-2">
                    <div class="image paralax-image">
                      <img
                        src="assets/images/process/process-02.jpg"
                        alt="Process Images"
                      />
                    </div>
                  </div>
                ...
                <div class="axil-working-process mb--100 mb_md--50 mb_sm--40">
                  <div class="thumbnail">
                    <div class="image paralax-image">
                      <img
                        src="assets/images/process/process-03.jpg"
                        alt="Process Images"
                      />
                    </div>
                  </div>
                  <div class="content">
                    <div class="inner">
                      <div class="section-title">
                        ...
                        <span class="sub-title extra06-color"
                          >our four step process</span
                        >
                ...
                <!-- Start Working Process  -->
                <div
                  class="axil-working-process text-left mb--100 mb_md--50 mb_sm--40"
                >
                  <div class="content order-2 order-lg-1">
                    <div class="inner">
                      <div class="section-title">
                        <span class="process-step-number">4</span>
                        <span class="sub-title extra07-color"
                          >our four step process</span
                        >
                  ...
                  <div class="thumbnail order-1 order-lg-2">
                    <div class="image paralax-image">
                      <img
                        src="assets/images/process/process-04.jpg"
                        alt="Process Images"
                      />
                    </div>
                  </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="section-title text-center">
                  <h2 class="title wow" data-splitting>See the results</h2>
                  <p class="subtitle-2 wow" data-splitting>
              ...
              <div class="col-lg-9 offset-lg-1">
                <div class="row">
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div
                      class="axil-counterup mt--60 text-center counter-first"
                    >
                      <h3 class="count primary-color">15</h3>
                      <p>
                        In total <br />
                        investments
                      </p>
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div
                      class="axil-counterup mt--60 text-center counter-second"
                    >
                      <h3 class="count primary-color">360</h3>
                      <p>
                        Investors <br />
                        a day
                      </p>
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div
                      class="axil-counterup mt--60 mt_md--30 mt_sm--30 text-center counter-third"
                    >
                      <h3 class="count primary-color">600</h3>
                      <p>
                        Avarage <br />
                        monthly investmentsa day
                      </p>
                    </div>
                  </div>
                  <!-- End Counterup Area -->
                  <div class="col-lg-12">
                    <div class="button-wrapper mt--60 text-center">
                      <a class="axil-button btn-large btn-transparent" href="#"
                        ><span class="button-text">Launch The Site</span
        ...
        <!-- Start Website Link  -->
        <div class="axil-website">
          <div class="thumbnail text-center">
            <img
              src="assets/images/featured/website-image.jpg"
              alt="Featured Images"
            />
          </div>
        </div>
